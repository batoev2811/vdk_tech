...
class SteponeFizlica extends StatelessWidget{
  const SteponeFizlica({super.key});

  @override
  Widget build(BuildContext context) {
    return Material(child: SteponeFizlicaState(),);
  }
}

class SteponeFizlicaState extends StatefulWidget {
  const SteponeFizlicaState({super.key});
...
class _SteponeFizliczip extends State<SteponeFizlicaState> {
